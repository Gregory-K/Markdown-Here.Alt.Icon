...
;(function () {
  ...
  function renderMarkdown(focusedElem, selectedRange, markdownRenderer, renderComplete) {
    ...
    markdownRenderer(focusedElem, selectedRange, function (mdHtml, mdCss) {
      ...
      aria-hidden="true" style="${holderCSS}">&#8203;</div>`
  ...
  //          to the user.
  function markdownHere(document, markdownRenderer, renderComplete) {
    ...
    if (wrappers && wrappers.length > 0) {
      ...
      renderMarkdown(focusedElem, range, markdownRenderer, function () {
        if (renderComplete) {
  ...
  markdownHere.looksLikeMarkdown = looksLikeMarkdown
