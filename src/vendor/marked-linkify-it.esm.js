...
var require_linkify_it = __commonJS({
  "node_modules/linkify-it/index.js"(exports, module) {
    ...
    LinkifyIt2.prototype.test = function test(text) {
    ...
    LinkifyIt2.prototype.pretest = function pretest(text) {
      return this.re.pretest.test(text);
    };
    LinkifyIt2.prototype.testSchemaAt = function testSchemaAt(text, schema, pos) {
      if (!this.__compiled__[schema.toLowerCase()]) {
        return 0;
      }
      return this.__compiled__[schema.toLowerCase()].validate(text, pos, this);
    };
    LinkifyIt2.prototype.match = function match(text) {
      var shift = 0, result = [];
    ...
    LinkifyIt2.prototype.matchAtStart = function matchAtStart(text) {
      this.__text_cache__ = text;
      this.__index__ = -1;
      if (!text.length)
        return null;
    ...
    module.exports = LinkifyIt2;
  }
});

// node_modules/marked-linkify-it/src/index.js
var import_linkify_it = __toESM(require_linkify_it(), 1);
function markedLinkifyIt(schemas = {}, options = {}) {
  const linkify = new import_linkify_it.default(schemas, options);
